...
#include "sqlite_zone_repository.h"
...
private:
    ...
    void on_zone_snapshot(const Events::ZoneSnapshotEvent& evt);
    void on_zone_update(const Events::ZoneUpdateEvent& evt);
};
