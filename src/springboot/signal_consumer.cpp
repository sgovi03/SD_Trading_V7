...
// Windows SDK (pulled in via curl → winsock → windows.h) defines ERROR as 0.
// Undefine it here AFTER all headers so it doesn't corrupt LogLevel::ERROR
// or AlertSeverity::ERROR in this translation unit.
#ifdef ERROR
#undef ERROR
#endif
