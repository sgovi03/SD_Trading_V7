...
public:
    ...
    /**
     * Calculate volume score (0-60 points, new system)
     * @param volume_profile Calculated volume profile
     * @param zone Zone being analyzed (for context)
     * @return Volume score contribution
     */
    double calculate_volume_score(const VolumeProfile& volume_profile, const Zone& zone) const;
