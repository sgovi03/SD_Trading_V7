...
struct ValidatorConfig {
    double max_gap_pct               = 3.0;   // Max |open - prev_close| / prev_close %
    double atr_spike_multiplier      = 4.0;   // Max (H-L) / rolling ATR multiple
    double max_volume_spike_mult     = 10.0;  // Max volume / avg_volume multiple
    double max_oi_spike_pct          = 20.0;  // Max |OI_delta| / prev_OI %
